	...
	function (e, t) {
					...
					t.removeClass("error success"),
						jQuery
							.ajax({
								type: "POST",
								url: jkit_ajax_url,
								data: { data: i, action: "jkit_element_ajax_jkit_mailchimp" },
								dataType: "json",
								encode: !0,
							})
							.done(function (e) {
								e.status_code >= 400
									? (t.addClass("error"), t.text(e.message))
									: (t.addClass("success"), t.text(r));
							})
							.fail(function () {
		...
		jQuery(window).on("elementor/frontend/init", () => {
			elementorFrontend.hooks.addAction(
				"frontend/element_ready/jkit_mailchimp.default",
				(e) => {
